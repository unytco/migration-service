...
The app (and the headless-migrator's open service) completes the flow with a single `migration_init` zome call on the new-DNA conductor — no off-chain service can do that (it opens the agent's own chain).
